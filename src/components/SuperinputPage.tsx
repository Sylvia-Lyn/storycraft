            ...
            <main className="flex-1 flex flex-col items-center justify-center p-8">
                <div className="w-full max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                        ...
                        {/* Card 3: 剧本杀剧本创作 */}
                        <div className="bg-white p-6 rounded-lg border-2 border-blue-500 shadow-lg cursor-pointer">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200">
                        <div className="flex flex-wrap items-center gap-4 mb-4">
                            <select className="bg-gray-900 text-white rounded-md px-4 py-2 text-sm font-semibold">
                                <option>Gemini-2.5-pro</option>
                            </select>
                            <button className="px-4 py-2 border border-blue-500 text-blue-500 rounded-md text-sm hover:bg-blue-50">续写模式</button>
                            <button className="px-4 py-2 border border-gray-300 text-gray-600 rounded-md text-sm hover:bg-gray-100">创作模式</button>
                            <select className="border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-600">
                                <option>文风参考：下拉按钮</option>
                            </select>
                            <select className="border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-600">
                                <option>提示词：下拉按钮</option>
                            </select>
                            <select className="border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-600">
                                <option>角色：下拉按钮</option>
                            </select>
                        </div>
                        <textarea
